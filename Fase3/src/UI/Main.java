...
import java.util.*;
import BussinessLayer.SubSimulacao.Simulacao;
import BussinessLayer.SubCampeonato.Segmentos;

public class Main {

    public static void main(String[] args) throws Exception {
        Simulacao simul = new Simulacao();
        ...
        */
        ...
        menu.setHandler(1,()->{
            ...
            for (int i = 0; tom < 0 || tom > 2; i++) {
                ...
                if (tom != 0) {
                    ...
                    if (tom == 1) {
                        simul.addJogador(username, password);
                    }
                    else {
                        simul.addAdministrador(username,password);
                    }
                }
            }
        });
        ...
        menu.setHandler(2,()->{
            ...
            for (int i = 0; tom < 0 || tom > 2; i++) {
                ...
                if (tom != 0) {
                    ...
                    String password = scann.nextLine();
                    if (tom == 1) {
                        System.out.println(simul.validaJogador(username, password));
                    }
                    else {
                        System.out.println(simul.validaAdministrador(username,password));
                    }
                }
            }
        });
        ...
        menu.setHandler(3,()->{
            try {
                ...
                int num_chicanes = 0;
                int opt = -1;
                ArrayList<Segmentos> seccoes = new ArrayList<>();
                for (int i = 0; opt !=0; i++) {
                    if (i > 0 && (opt < 0 || opt > 2))
                        System.out.println("A opção escolhida não se encontra nas opções disponíveis!\n");
                    else {
                        ...
                        if (opt != 0) {
                            ...
                            Segmentos s = new Segmentos(opt, num_curvas + num_chicanes, gdu);
                            if (opt == 1)
                                num_curvas++;
                            else
                                num_chicanes++;
                ...
                simul.addCircuito(nome,distancia,num_curvas,num_chicanes,n_voltas,seccoes);
            }
            catch (Exception e) {
        ...
        menu.setHandler(4,()->{
            try {
                ...
                simul.addPiloto(nome,chuvaVsSeco,SegVSAgre);
            }
            catch (Exception e) {
        ...
        menu.setHandler(5,()->{
            try {
                ...
                for (int i = 0; opt !=0; i++) {
                    ...
                    opt = is.nextInt();
                    if (opt == 1) {
                        Collection<Circuito> circ= simul.getCircuitos();
                        for (Circuito m : circ) {
                ...
                simul.addCampeonato(nome,circuitos);
                simul.getCampeonato(nome);
            }
            catch (Exception e) {
                System.out.println(e);
            }
            ...
            try {
                ...
                for (int i = 0; opt<0 || opt>4; i++) {
                    if (i > 0)
                        ...
                        int cilindrada = 0;
                        if (opt == 2 || opt == 3) {
                                while (!simul.validacilindrada(opt,cilindrada)) {
                        ...
                        if (opt == 1 || opt == 2 || opt == 3) {
                            ...
                            for (int j = 0; opt1 < 1 || opt1 > 2; j++) {
                                ...
                                if (opt1 == 2) {
                                    ...
                                    if (opt == 3) {
                                        simul.addCarroGTHbr(marca,modelo,cilindrada,potenciaMC,taxa,potenciaME);
                                    }
                                    else if (opt == 1) {
                                        simul.addCarroC1Hbr(marca,modelo,potenciaMC,potenciaME);
                                    }
                                    else
                                        simul.addCarroC2Hbr(marca,modelo,cilindrada,potenciaMC,potenciaME);
                                }
                                else {

                                    if (opt == 3) {
                                        simul.addCarroGT(marca,modelo,cilindrada,potenciaMC,taxa);
                                    }
                                    else if (opt == 1) {
                                        simul.addCarroC1(marca,modelo,potenciaMC);
                                    }
                                    else if (opt == 2) {
                                        simul.addCarroC2(marca, modelo, cilindrada, potenciaMC);
                                    }
                                }
                            }
                        }
                        else if (opt == 4){
                            simul.addCarroSC(marca,modelo,cilindrada,potenciaMC,fiabilidade);
                        }
 ...
 */
        ...
        Registo r1= new Registo(1,simul.getCarro("Porsche 911 GT3 cup "),simul.getPiloto("Miguel"),simul.getJogador("goncalo"));
        Registo r2= new Registo(2,simul.getCarro("Pagani  Huarya R"),simul.getPiloto("André"),simul.getJogador("bot"));
        Map<Integer, Registo> regs=new HashMap<>();
        regs.put(1,r1);
        regs.put(2,r2);
        List<Circuito> c = (List<Circuito>) simul.getCircuitos();
